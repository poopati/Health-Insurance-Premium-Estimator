...
def preprocess_input(input_dict):
    ...
    expected_columns = [
        'age', 'number_of_dependants', 'income_level', 'income_lakhs', 'insurance_plan', 'genetical_risk', 'normalised_risk_score',
    ...
    for key, value in input_dict.items():
        if key == 'Gender' and value == 'Male':
            ...
            df['income_level'] = income_level_encoding.get(value,1)
